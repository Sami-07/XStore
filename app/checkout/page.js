      ...
      <form className='md:w-1/2  md:px-0 mx-auto mt-40 md:mt-24'>
        ...
        {initiated && <div className=''>
          <div className='flex justify-evenly items-center gap-5 bg-amber-300 p-2 md:p-4 rounded-xl '>
            ...
            <p className='w-2/3 text-sm md:text-base'>Dont choose any UPI App or QR code to pay. <strong> Complete the payment by entering any UPI ID and proceed. </strong>This is a Dummy Payment Gateway. So you wont be debited any amount.</p>
          </div>
