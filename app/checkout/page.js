      ...
      <form className='md:w-1/2  md:px-0 mx-auto mt-40 md:mt-24'>
        ...
        {initiated && <div className=''>
          <div className='flex justify-evenly items-center gap-5 bg-amber-300 p-2 md:p-4 rounded-xl '>
            ...
            <p className='w-2/3 text-sm md:text-base'>This is a Dummy Payment Gateway. So, to place an order, you have to do a dummy transaction by entering your UPI ID. You won't be debited as this is just for demonstration.</p>
          </div>
