      ...
      <section className="bg-gray-50">
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 mt-32 md:mt-20">
          <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900">
            <img   data-aos="fade-up" className="w-16 h-16 mr-3 bg-black" src="/images/transparent X logo.png" alt="logo" />
            Store
          </a>
          <div data-aos="fade-up" className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div   className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1  data-aos="fade-up" className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                Create an Account
              </h1>
