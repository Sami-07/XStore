    ...
    return (
        <div>
            <div className=' open-font '>
                <nav ref={ref} className=' flex w-[60vw] md:w-[28vw] lg:w-[22vw] h-screen top-0 fixed  transform transition-transform translate-x-0 z-50' style={{ backgroundColor: "#793FDF" }}>
